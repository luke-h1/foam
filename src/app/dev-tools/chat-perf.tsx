...
// Inline EXPO_PUBLIC_APP_VARIANT literals let Metro constant-fold the require away, dropping the chat perf harness from production - do not hoist them (mirrors StorybookRoute.tsx).
