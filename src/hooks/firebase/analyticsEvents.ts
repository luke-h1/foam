 ...
 * wrong param shape fails to compile. Add an entry here when instrumenting a
 * new call site. Names follow GA4 rules (snake_case, <=40 chars, not reserved)
 * and params must be primitives. `screen_view` is reserved and goes through
 * `logAnalyticsScreenView`, not this map.
 */
