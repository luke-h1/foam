const en = {
  ...
  chat: {
    ...
    userActions: {
      ...
      warnReasonSpam: 'Spam',
      warnReasonHarassment: 'Harassment',
      warnReasonRules: 'Breaking channel rules',
      banUser: 'Ban User',
      banUserSubtitle: 'Permanent moderation',
      recentMessages: 'Recent messages',
      copiedToClipboard: 'Copied to clipboard',
      copiedUsername: 'Copied username',
      deleteCommandSent: 'Message deleted',
      failedToBlockUser: 'Failed to block user',
    },
    modCommands: {
      failed: 'Moderation action failed',
      timedOut: 'Timed out {{login}} for {{seconds}}s',
      banned: 'Banned {{login}}',
      unbanned: 'Unbanned {{login}}',
      warned: 'Warned {{login}}',
      announced: 'Announcement sent',
      shoutedOut: 'Shoutout sent for {{login}}',
    ...
    emotePreview: {
      ...
      saveImageSubtitle: 'Save to your photo gallery',
      nameCopied: 'Emote name copied',
      urlCopied: 'Emote URL copied',
      imageSaved: 'Emote saved to gallery',
      imageSaveFailed: 'Could not save emote',
    },
    badgePreview: {
    ...
    notices: {
      ...
      modAnniversary: 'Mod anniversary',
      channelPointsEarned_one: '+{{count}} point',
      channelPointsEarned_other: '+{{count}} points',
  ...
  stream: {
    ...
    clipUnavailable: 'Clipping is not available for this stream right now',
    editClip: 'Edit',
    clipProcessing: 'Processing…',
    clipViews: '{{count}} views',
    myClipsEmpty: 'No clips yet',
    myClipsEmptyDescription:
      'Clips you create from the live player will show up here.',
    removeFromMyClips: 'Remove from My Clips',
    ...
    sleepTimerRemaining: 'Sleep timer ({{minutes}} min left)',
  ...
  settings: {
    ...
    emotesAndBadges: 'Emotes & Badges',
    emotesAndBadgesDescription:
      'Browse global Twitch, BTTV, FFZ, and 7TV emotes and badges',
    savedPhrases: 'Saved Phrases',
    savedPhrasesDescription: 'Save phrases to quickly insert while chatting',
    myClips: 'My Clips',
    myClipsDescription: 'Clips you have created in foam',
    emoteBadgeViewerEmotes: 'Emotes',
    emoteBadgeViewerBadges: 'Badges',
    emoteBadgeViewerNoBadges: 'No badges available',
    cache: 'Cache',
    ...
    updateAppDescription: 'Get the latest version from the store',
    updateBundle: 'Update Bundle',
    updateBundleDescription: 'Download the latest over-the-air update',
    bundleChecking: 'Checking for updates…',
    bundleUpToDate: 'You are on the latest version',
    bundleDownloaded: 'Update downloaded',
    bundleDownloadedDescription: 'Restart the app to apply the update',
    bundleRestart: 'Restart',
    bundleUpdateFailed: 'Could not download update',
    otaUnavailable: 'Over-the-air updates are not available for this build',
    updateStoreUnavailable: 'Could not open the store',
    developer: 'Developer',
    more: 'More',
    devTools: 'Dev Tools',
    devToolsDescription:
    ...
    shareAnalyticsFooter:
      'When on, Foam sends anonymous usage data (such as which screens are opened, which can include channel names) to help improve the app. It is never linked to your Twitch account, and no chat messages are collected. Turn this off to opt out.',
  ...
  preferences: {
    ...
    removePhraseConfirm: 'Remove "{{phrase}}" from your saved phrases?',
    noSavedPhrases: 'No saved phrases',
    noSavedPhrasesDescription:
      'Save phrases you send often, then insert them into the composer with a tap.',
    addSavedPhrasePlaceholder: 'Add a phrase to save…',
    savedPhrasesFooter_one:
      '{{count}} phrase · Tap a phrase in chat to insert it.',
    savedPhrasesFooter_other:
      '{{count}} phrases · Tap a phrase in chat to insert it.',
    insertSavedPhrase: 'Insert Phrase',
    savedPhrasesSheetTitle: 'Saved Phrases',
    savedPhrasesSheetEmpty: 'No saved phrases yet',
    savedPhrasesSheetEmptyHint:
      'Add phrases in Settings to insert them here with a tap.',
    manageSavedPhrases: 'Manage saved phrases',
  ...
  devTools: {
    ...
    paintRendererDescription:
      'Choose the username paint renderer. Off renders default name colours; WebView is a dev-only reference.',
    paintRendererOff: 'Off',
