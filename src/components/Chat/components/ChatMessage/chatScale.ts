...
/**
 * The resolved chat metrics for a preference pair. Height estimation
 * (util/pretextChatHeight.ts) measures against this same object, so every
 * value the renderer uses must come from here rather than a local literal.
 */
