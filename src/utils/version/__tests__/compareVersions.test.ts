...
describe('compareVersions', () => {
  ...
  test('returns -1 when first version is less than second', () => {
  ...
  test('returns 1 when first version is greater than second', () => {
...
describe('isUpdateRequired', () => {
  test('returns true when current version is below minimum', () => {
  ...
  test('returns false when current version equals minimum', () => {
    expect(isUpdateRequired('1.0.0', '1.0.0')).toBe(false);
    expect(isUpdateRequired('0.0.36', '0.0.36')).toBe(false);
  });

  test('returns false when current version is above minimum', () => {
  ...
  test('returns false when both versions are empty', () => {
