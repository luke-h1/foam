...
/**
 * Twitch to 7TV user-id resolution cache: bounded in-memory map for repeat
 * lookups, MMKV persistence with positive/negative TTLs, and in-flight
 * request dedup. Callers only interact with `resolve` and `clear`.
 */
